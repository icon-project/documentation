...
```shell
$ docker pull iconloop/prep-node:1910151024x373518
```
...
```shell
$ docker run -d  -p 9000:9000 -p 7100:7100 -v ${PWD}/data:/data iconloop/prep-node:1910151024x373518
```
...
services:
   prep:
      image: iconloop/prep-node:1910151024x373518
...
0de99e33cdc9     iconloop/prep-node:1910151024x373518    "/src/entrypoint.sh"      2 minutes ago        Up 2 minutes(healthy)    0.0.0.0:7100->7100/tcp, 0.0.0.0:9000->9000/tcp prep_prep_1
```
...
[2019-09-30 02:19:01.468] P-REP package version info - 1910151024x373518
...
```yml
version: '3' services:    container:        image: 'iconloop/prep-node:1910151024x373518'        container_name: 'prep-node'        volumes:            - ./data:/data        ports:           - 9000:9000           - 7100:7100       environment:          TZ: "America/Los_Angeles"
```
